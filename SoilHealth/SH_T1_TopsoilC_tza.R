...
sagcot_dummy <- setValues(org_c_0_5_crop, NA)
...
org_c_0_5_mask <- mask(x=org_c_0_5_crop, mask=sagcot_r)
org_c_5_15_mask <- mask(x=org_c_5_15_crop, mask=sagcot_r)
org_c_15_30_mask <- mask(x=org_c_15_30_crop, mask=sagcot_r)
...
#drop unneccessary dataframes
rm(sagcot_dummy, org_c_0_5_crop, org_c_5_15_crop, org_c_15_30_crop, org_c_0_5_mask, org_c_5_15_mask, org_c_15_30_mask, sagcot_r)
...
#need to specify correct output location
#write outputs
writeRaster(org_c,"sagcot_org_c.tif",format='GTiff')
s3 <- newS3()
s3$writeS3(bucket = "ci-vsindicators", source_path = "sagcot_org_c.tif", target_path = "Soil_Health/sagcot_org_c.tif")
