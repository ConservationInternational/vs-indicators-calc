...
# NOTE: The following three lines originally had silt in place of sand. This was causing sand not to
# be written among other downstream issues.
...
gha_dummy <- setValues(ph_0_5_crop, NA)
...
ph_0_5_mask <- mask(x=ph_0_5_crop, mask=gha_r)
ph_5_15_mask <- mask(x=ph_5_15_crop, mask=gha_r)
ph_15_30_mask <- mask(x=ph_15_30_crop, mask=gha_r)
silt_0_5_mask <- mask(x=silt_0_5_crop, mask=gha_r)
silt_5_15_mask <- mask(x=silt_5_15_crop, mask=gha_r)
silt_15_30_mask <- mask(x=silt_15_30_crop, mask=gha_r)
clay_0_5_mask <- mask(x=clay_0_5_crop, mask=gha_r)
clay_5_15_mask <- mask(x=clay_5_15_crop, mask=gha_r)
clay_15_30_mask <- mask(x=clay_15_30_crop, mask=gha_r)
sand_0_5_mask <- mask(x=sand_0_5_crop, mask=gha_r)
sand_5_15_mask <- mask(x=sand_5_15_crop, mask=gha_r)
sand_15_30_mask <- mask(x=sand_15_30_crop, mask=gha_r)

#drop unneccessary dataframes
rm(ph_0_5_crop, ph_5_15_crop, ph_15_30_crop, clay_0_5_crop, clay_5_15_crop, clay_15_30_crop, silt_0_5_crop, silt_5_15_crop, silt_15_30_crop)
rm(ph_0_5, ph_5_15, ph_15_30, clay_0_5, clay_5_15, clay_15_30, silt_0_5, silt_5_15, silt_15_30)
...
#write outputs
writeRaster(ph,"gha_ph.tif",format='GTiff', overwrite=TRUE)
writeRaster(silt,"gha_silt.tif",format='GTiff', overwrite=TRUE)
writeRaster(clay,"gha_clay.tif",format='GTiff', overwrite=TRUE)
writeRaster(sand,"gha_sand.tif",format='GTiff', overwrite=TRUE)

s3 <- newS3()
s3$writeS3(bucket = "ci-vsindicators", source_path = "gha_ph.tif", target_path = "Soil_Health/gha_ph.tif")
s3$writeS3(bucket = "ci-vsindicators", source_path = "gha_silt.tif", target_path = "Soil_Health/gha_silt.tif")
s3$writeS3(bucket = "ci-vsindicators", source_path = "gha_clay.tif", target_path = "Soil_Health/gha_clay.tif")
s3$writeS3(bucket = "ci-vsindicators", source_path = "gha_sand.tif", target_path = "Soil_Health/gha_sand.tif")

#drop unneccessary dataframes
rm(ph_0_5_mask, ph_5_15_mask, ph_15_30_mask, clay_0_5_mask, clay_5_15_mask, clay_15_30_mask, silt_0_5_mask, silt_5_15_mask, silt_15_30_mask)
...
hist(SH60, main="Soil Carbon Defecit Indicator (0-20cm)", 
     col= "purple", 
     maxpixels=551700)

#write outputs
writeRaster(sh42, filename="soil_carbon_deficit_gha.tif", format='GTiff', overwrite=TRUE)
writeRaster(SH60, filename="soil_carbon_deficit_indicator_gha.tif", format='GTiff', overwrite=TRUE)
s3$writeS3(bucket = "ci-vsindicators", source_path = "soil_carbon_deficit_gha.tif", target_path = "Soil_Health/soil_carbon_deficit_gha.tif")
s3$writeS3(bucket = "ci-vsindicators", source_path = "soil_carbon_deficit_gha.tif", target_path = "Soil_Health/soil_carbon_deficit_gha.tif")

#display 
plot(SH60, main="GHA - Soil Carbon Defecit Indicator (0-20cm)")
hist(SH60, main="GHA - Soil Carbon Defecit Indicator (0-20cm)", col="blue")

plot(sh42, main="GHA - Soil Carbon Defecit (0-20cm)")
hist(sh42, main="GHA - Soil Carbon Defecit (0-20cm)", col="blue")

plot(Cref, main="GHA - Carbon Reference (0-20cm)")
hist(Cref, main="GHA - Carbon Reference  (0-20cm)", col="blue")

plot(org_c, main="GHA - Organic Carbon (0-20cm)")
hist(org_c, main="GHA - Organic Carbon (0-20cm)", col="blue")
