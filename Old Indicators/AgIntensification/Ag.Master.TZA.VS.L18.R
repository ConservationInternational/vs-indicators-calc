...
eval(run1)
  # only keep relevant LANDSCAPE and YEAR: 
    #LANDSCAPE: L18
    #YEAR: 2014
    #the team visited L18 in 2014; however, some surveys were enterred in 2013 or 2015; keep those 
    field_data <- subset(FieldData.TZA.VS, Landscape == "L18" & (Data.entry.year == "2014"| Data.entry.year == "2013"| Data.entry.year == "2015"))
    num_crops <- subset(NumCrops.TZA.VS, Landscape == "L18" & (Data.entry.year == "2014"| Data.entry.year == "2013"| Data.entry.year == "2015"), 
                    select = c(country_y3hhid_plotnum, y3_hhid, plotnum, numcrops))
    pct_maize <- subset(PctMaize.TZA.VS, Landscape == "L18" & (Data.entry.year == "2014"| Data.entry.year == "2013"| Data.entry.year == "2015"), 
...
write.csv(output, file = "Ag.Intensification.TZA.VS.L18.2014.csv")